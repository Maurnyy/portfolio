<script>
  ...
  function toggleVisibleBusiness() {
    visibleBusiness = !visibleBusiness;
  }
</script>

<div class="app">
  <div class="flex flex-col gap-y-36 max-w-5x1 mx-10 px-4 my-24 print:my-0">
    <main class="flex flex-col gap-y-28">
      <section class="flex flex-col gap-y-16">
        <div class="flex flex-col gap-4">
          ...
          <p>
            ...
            <span class="font-bold underline">
              <a href="/ticorporate">Ticorporate</a>
            </span>
          </p>
        </div>
        <div
          class="lading-loose [&amp;_a]:font-bold [&amp;_a]:underline font-mono"
        >
          <h2
          ...
          <p>
            ...
            alusta Elisan ja Jamkin väliselle yhteistyölle. Alustan tarkoituksena
            on parantaa kommunikaatiota ja läpinäkyvyyttä mahdollisten organisaatioiden
          ...
          <p>
            ...
            postauksiaan. Lisäksi sovelluksen käyttäjien tulee pystyä
            kirjautumaan sovellukseen ja siitä ulos. Sovelluksen tulee täyttää
            WCAG 2.2 saavutettavuusvaatimukset. Sovelluksen tulee pyöriä
        ...
        >
          ...
          <div>
            ...
            <p>
              ...
              sovellusidea pareittain. Minun alkuperäinen ideani oli suunnitella
              ERP-sovellus rakennusalalle. Vaikka minulla oli intoa lähteä suunnittelemaan
              ERP-sovellusta ja selkeä visio siihen, niin koin, että oppimisen kannalta
              olisi järkevämpi hakea asiakasprojektiin.
            </p>
          </div>
          <div>
            <h2 class="font-bold text-1xl bg-clip-text mr-2 mt-8">
            ...
            <br />
            <p>
              <strong>Alunperin minun piti toimia projektissa</strong>
              pelkästään
              <strong>Fullstack-kehittäjänä</strong>
              ja liiketalous-osaajana. Olimme keskustelleet ryhmän kanssa Product
              Ownerin roolin valitsemisesta ja tarkoituksena oli valita se vasta
              ensimmäisen yhteisen palaverin jälkeen, mutta Aleksi oli kuullut väärin
              ja esitteli minut <strong>Product Ownerina</strong> Elisalle. Vaikka
              sain roolin vahingossa, niin koin selviytyväni siitä maaliin. Kurssin
              alussa en asettanut itselleni liiketalouden osalta mitään tavoitteita,
              mutta halusin kehittyä paremmaksi koodariksi.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              rakentamiseen. Tässä vaiheessa olin oman mukavuusalueen
              ulkopuolella ja tuntui, että olin hieman hukassa projektin kanssa.
              Kuitenkin mitä pidemmälle saimme suunniteltua projektia, niin sitä
              vahvemmaksi tuli visio siitä miten se voitaisiin toteuttaa.
            </p>
            <br />
            <p>
              <strong>Koin projektin alussa</strong>, että haluan lähteä
              vahvasti rakentamaan tietokantaa ja ottaa vastuulle lomakkeen
              rakentamisen frontin ja backendin puolella. Backendin osalta
              lähdimme liikenteeseen sillä, että AD rakenti Node Expressin
              pohjan ja minä lähdin suunnittelemaan miten Mongo-tietokanta
              toteutettaisiin lomakkeen osalta.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            {#if visibleNotify}
              ...
              />
              <p>
                Kuva 1. Haetaan kaikkien kommentoijien ja postauksen tekijän id
                ja lähetetään tietokantaan.
              </p>
              <br />
              <img
              ...
              <br />
              <img
                src="/assets/notification_read.png"
        ...
        >
          ...
          <p>
            ...
            jouduin heti epämukavuusalueella, kun odotin pääseväni koodaaman
            heti alkuun, mutta jouduinkin suunnittelemaan sovelluksen sisältöä.
            ...
            hyödyllisenä sen, että aloitimme päivän 15 minuutin palaverilla,
            jossa kävimme ryhmän kesken läpi mitä kukin tekee päivän aikana.
          ...
          <p>
            ...
            työtehtävässä valtavasti ja opetti kuinka backlog kannattaa
            rakentaa.
          </p>
          <br />
          <p>
            ...
            Angular Materials. Angular Materials vaihdon jälkeen datepicker toimi
            ja ei tarvinnut tehdä muutoksia omaan koodiin. Olin siis tehnyt "turhaa"
            työtä, mutta tämän turhan työn ansiosta opin lukemaan paremmin koodia.
          </p>
          <br />
          <p>
            ...
            pohtimaan miten käyttäjä saa ilmoituksen ja mitä tapahtuu, kun se saa
            ilmoituksen. Tästä opin ajattelemaan asioita tietokanta näkökulmasta,
            sekä sen, että isot kokonaisuudet on hyvä pilkkoa pieniin osiin ja ratkaista
            vasta sen jälkeen.
          </p>
          <br />
          <p>
            <strong
              >Olen hyvin tyytyväinen omaan panokseeni Ticorporatessa</strong
            ...
            vahvisti ajatuksiani siitä, mitä haluan tehdä työkseni, ja ymmärsin,
            että tarvitsen lisää kokemusta kasvaakseni paremmaksi ohjelmoijaksi.
            Koen vahvuuteni olevan tietokannoissa.
          </p>
        </div>
        <div
        ...
        >
          <a
            href="https://github.com/Maurnyy/"
            target="_blank"
            rel="noreferrer nofollow"
            aria-label="Github profile for Mauri Nyyssönen"
          >
            <svg viewBox="0 0 128 128" height="1.5rem" width="1.5rem">
              <g fill="#181616">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
          ...
          <a
            href="https://www.linkedin.com/in/maurinyyssonen/"
            target="_blank"
            rel="noreferrer nofollow"
            aria-label="LinkedIn profile for Mauri Nyyssönen"
          >
            <svg viewBox="0 0 128 128" height="1.5rem" width="1.5rem">
              <path
